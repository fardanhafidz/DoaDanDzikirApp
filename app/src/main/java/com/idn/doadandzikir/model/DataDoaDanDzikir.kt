...
object DataDoaDanDzikir {
    ...
    val listDataQauliyyah: List<DoaDanDzikirItem>
        get() {
    ...
    private val descDzikir = arrayOf(
        "Tahlil", "Takbir", "Tahmid", "Tasbih", "Hauqolah", "Istighfar", "Shalawat"
    )
    ...
    val listDataDzikirSetiapSaat: List<DoaDanDzikirItem>
        get() {
            val listData = mutableListOf<DoaDanDzikirItem>()
